...
$result = mysql_query("select * from employees WHERE id='$x'");
...
<img id="i" width="245" height="236" src="imageView.php?image_id=<?php echo $row["eid"]; ?>" /><br/>
<style>
body 
{
	-open .navbar-fixed-top
...
<div id="lg" class="wrapper">
   <form class="form-signin" method="post" action="">       
      ...
      <label>Name Of The Employee</label><br><input type="text" class="form-control" id="uname1" name="uname1"  required="" value='<?php echo  $uname1; ?>'<br><br>
     ...
     <p><a href="imageUpload.php" id="lk1"> Update profile photo</a> </p> 
	 ...
	 if(isset($_POST['save']))
		 {
				 ...
				 $el=$_POST['eml']; 
				 $nmb=$_POST['nbr'];
				 $q=mysql_query("UPDATE employees SET name='$nm',password='$pw',department='$dp',designation='$dg',email='$el',number='$nmb' WHERE id='$x'");
					if($q)
					  {
