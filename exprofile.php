...
$result1 = mysql_query("select * from executives WHERE id='$x'");
...
<img id="i" width="244" height="236" src="imageView1.php?image_id=<?php echo $row["eid"]; ?>" /><br/>
<style>
body 
{
	-open .navbar-fixed-top
...
<div id="lg" class="wrapper">
    ...
    <p><span class="glyphicon glyphicon-cog" id="stgs"></span><a href="exeditpro.php" id="lk"> Edit Profile</a> </p> 
