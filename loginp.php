...
<script>
  function run()
   {
        window.location = 'viewemplve.php';
   }
</script>
       ...
       <div class="tab-pane active" id="Login">
           <form role="form" action="" method="post" class="login-form">
	            <div class="form-group">
	               <input type="text" id="form-username" name="form-username" placeholder="Employee ID" class="form-username form-control">
	            </div>
	            <div class="form-group">
			...
			<ul><li><center>Not yet registered? <a href="#Registration"  data-toggle="tab">Register here.</a></center></li></ul>
				<br><center><a href="forgotpass.php">Forgot Password?</a></center>
		 </div>
        <div class="tab-pane" id="Registration">
             <form role="form" action="" method="post" class="login-form">
				<div class="form-group">
					<input type="text" id="form-username" name="form-username" placeholder="Enter Name of the Employee " class="form-username form-control">
	            </div>
				<div class="form-group">
	                <input type="text" id="form-id" name="form-id" placeholder="Enter Employee ID" class="form-username form-control">
	            </div>
				<div class="form-group">
...
if(isset($_POST['lgn']))
	{
		...
		if($nm!= "" && $pwrd!=  "")
		  {
					$query = mysql_query("SELECT * from employees WHERE id='$nm'");
						if (mysql_num_rows($query) != 0)
						  {
							  $q = mysql_query("SELECT * from employees WHERE password='$pwrd'"); 
...
if(isset($_POST['reg']))
    {
				...
				$eal=$_POST['form-emil']; 
				$nr=$_POST['form-nber']; 
				$query = mysql_query("SELECT * from employees WHERE id='$uiid'");
							   if (mysql_num_rows($query) != 0)
								 {
								 ...
								 {
									   $query="insert into employees(name,id,password,department,designation,email,number) values('$ne','$uiid','$pwd','$dpt','$dgn','$eal','$nr')";
